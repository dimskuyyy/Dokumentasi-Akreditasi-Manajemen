    ...
    public function list()
    {
        ...
        if ($req->isAJAX()) {
            ...
            if($req->getVar("id") == null){
                $model1 = $model1->multiDataPenelitian()->where('proyek_user_id', AuthUser()->id);
                $model2 = $model2->multiDataPenelitian()->where('proyek_user_id', AuthUser()->id);
            }else{
                $model1 = $model1->multiDataPenelitian()->where('proyek_user_id', $req->getVar("id"));
                $model2 = $model2->multiDataPenelitian()->where('proyek_user_id', $req->getVar("id"));
            }
    ...
    public function detail()
    {
        ...
        if ($req->isAJAX()) {
            ...
            if ($id != null) {
                ...
                if (!empty($data['proyek_id']) && $data['proyek_type'] == 1) {
