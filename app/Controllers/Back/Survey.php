    ...
    public function save()
    {
        ...
        if ($req->isAJAX()) {
            ...
            $data = [
                ...
                'program_kuliah'            => $req->getVar('program_kuliah'),
            ...
            $kuis = [
                'umri_sarjana'                => $req->getVar('umri_sarjana'),
                'umri_peringkat'              => $req->getVar('umri_peringkat'),
                'umri_akreditasi_prodi'       => $req->getVar('umri_akreditasi_prodi'),
                'umri_pengalaman_kerja'       => $req->getVar('umri_pengalaman_kerja'),
                'umri_personality'            => $req->getVar('umri_personality'),
                'umri_manfaat'                => $req->getVar('umri_manfaat'),
                'umri_manfaat_kerja'          => $req->getVar('umri_manfaat_kerja'),
                'umri_manfaat_karir'          => $req->getVar('umri_manfaat_karir'),
