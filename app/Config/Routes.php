...
$routes->group('wbpanel', ['namespace' => 'App\Controllers\Back'], static function ($routes) {
    ...
    $routes->group('/', ['filter' => ['isLoggedIn'], 'namespace' => 'App\Controllers\Back'], static function ($routes) {
        ...
        $routes->group('check-dekan', ['filter' => ['taskforceOnly'], 'namespace' => 'App\Controllers\Back'], static function ($routes) {
            ...
            $routes->post('sop/list', 'SOP::list');
            $routes->post('sop/info', 'SOP::detail');
            $routes->post('renstra/list', 'Renstra::list');
            $routes->post('renstra/info', 'Renstra::detail');
            $routes->post('anggaran/list', 'Anggaran::list');
            $routes->post('anggaran/info', 'Anggaran::detail');
            ...
            $routes->post('panduan-akademik/list', 'PanduanAkademik::list');
            $routes->post('panduan-akademik/info', 'PanduanAkademik::detail');
            $routes->post('etika-akademik/list', 'EtikaAkademik::list');
            $routes->post('etika-akademik/info', 'EtikaAkademik::detail');
