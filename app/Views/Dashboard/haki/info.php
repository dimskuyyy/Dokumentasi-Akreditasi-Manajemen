    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                <label for='nama'>Nama HaKi</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['haki_nama'] : '' ?>" id="nama" readonly>
            </div>
            <div class="form-group">
                <label for='klasifikasi'>Klasifikasi HaKi</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['haki_klasifikasi'] : '' ?>" id="klasifikasi" readonly>
            </div>
            <div class="form-group">
                <label for='nomor'>Nomor HaKi</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['haki_nomor'] : '' ?>" id="nomor" readonly>
            </div>
            <div class="form-group">
