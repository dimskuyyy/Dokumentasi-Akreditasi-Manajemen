    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?= isset($data) ? $data['studi_tahun'] : '' ?>" id="nama" readonly>
            </div>
            <div class="form-group">
                <label for='lama'>Lama Studi</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['studi_lama'] : '' ?>" id="nama" readonly>
            </div>
            <div class="form-group">
