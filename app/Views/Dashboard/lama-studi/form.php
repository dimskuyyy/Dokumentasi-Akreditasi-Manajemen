...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List Lama Studi Mahasiswa</button>
        </div><br><br>
        <?php echo form_open('#', ['class' => 'form-post']);
        if (isset($data)) {
            echo form_hidden('id', $data['studi_id']);
        }
        ?>
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group">
                        ...
                        <input type="number" min="1900" max="2200" name="tahun" class="form-control" value="<?= isset($data) ? $data['studi_tahun'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for='lama'>Lama Studi</label><br>
                        <input type="text" name="lama" class="form-control" value="<?= isset($data) ? $data['studi_lama'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="hidden" name="media" id="media-id" value="<?= isset($data) ? $data['studi_media_id'] : '' ?>">
