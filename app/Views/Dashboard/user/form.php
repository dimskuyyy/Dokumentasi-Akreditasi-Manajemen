    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group" id="form-level">
                ...
                <label><input type="radio" class="type" name="type" value="5" <?= isset($data) ? ($data['user_type'] == 5 ? 'checked' : '') : 'checked' ?> required> Dosen</label>
                <label><input type="radio" class="type" name="type" value="6" <?= isset($data) ? ($data['user_type'] == 6 ? 'checked' : '') : '' ?> required> Mahasiswa</label>
                <label><input type="radio" class="type" name="type" value="7" <?= isset($data) ? ($data['user_type'] == 7 ? 'checked' : '') : '' ?> required> Alumni</label>
            </div>
