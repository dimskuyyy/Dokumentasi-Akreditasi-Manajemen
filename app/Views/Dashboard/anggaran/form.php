...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List Dokumen Anggaran</button>
        </div><br><br>
        <?php echo form_open('#', ['class' => 'form-post']);
        if (isset($data)) {
            echo form_hidden('id', $data['ra_id']);
        }
        ?>
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group">
                        <label for='tahun'>Tahun Anggaran</label><br>
                        <input type="number" min="1900" max="2200" name="tahun" class="form-control" value="<?= isset($data) ? $data['ra_tahun'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for='media'>Media</label><br>
                        <div class="choose-media">
                            <a href="#" class="btn btn-sm btn-flat btn-primary btn-media" data-backdrop="static"><i class="fa fa-plus"></i> Unggah Dokumen Anggaran<span id="text-optional"></span></a>
                            <button type="button" class="btn btn-default btn-flat btn-sm btn-reset-media"><i class="fa fa-recycle" aria-hidden="true"></i></button>
                        </div>
                        <input type="hidden" name="media" id="media-id" value="<?= isset($data) ? $data['ra_media_id'] : '' ?>">
