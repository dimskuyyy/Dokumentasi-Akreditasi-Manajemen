...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List Dokumen Renstra</button>
        </div><br><br>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group">
                        <label for='tahun'>Tahun Renstra</label><br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="choose-media">
                            <a href="#" class="btn btn-sm btn-flat btn-primary btn-media" data-backdrop="static"><i class="fa fa-plus"></i> Unggah Dokumen Renstra<span id="text-optional"></span></a>
