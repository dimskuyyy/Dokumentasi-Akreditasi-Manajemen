...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List SK</button>
        </div><br><br>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for='nama'>Nama SK</label><br>
                        <input type="text" name="nama" class="form-control" value="<?= isset($data) ? $data['dokumen_nama'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for='nomor'>Nomor SK</label><br>
                        <input type="text" name="nomor" class="form-control" value="<?= isset($data) ? $data['dokumen_nomor'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for='media'>Media</label><br>
                        <div class="choose-media">
                            <a href="#" class="btn btn-sm btn-flat btn-primary btn-media" data-backdrop="static"><i class="fa fa-plus"></i> Unggah Dokumen SK<span id="text-optional"></span></a>
...
<script>
    $(document).ready(function() {
        ...
        $('.form-post').submit(function(e) {
            ...
            $.ajax({
                url: base_url + '/surat-keputusan/save',
                type: 'post',
                dataType: 'json',
                data: formData,
                contentType: false,
        ...
        $('.btn-media').click(function(e) {
            ...
            setLoadingBtn(btn);
            $.ajax({
                url: base_url + '/surat-keputusan/media',
                data: {
                    key: 'cover'
                },
                type: 'post',
