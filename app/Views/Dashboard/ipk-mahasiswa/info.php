    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?= isset($data) ? $data['ipk_tahun'] : '' ?>" id="nama" readonly>
            </div>
            <div class="form-group">
                <label for='rata_rata'>Rata Rata IPK</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['ipk_rata_rata'] : '' ?>" id="nama" readonly>
            </div>
            <div class="form-group">
                <label for='dosen'>Nama Dosen</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['user_nama'] : '' ?>" id="dosen" readonly>
            </div>
            <div class="form-group">
