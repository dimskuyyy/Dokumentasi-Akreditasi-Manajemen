...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List IPK Mahasiswa</button>
        </div><br><br>
        <?php echo form_open('#', ['class' => 'form-post']);
        if (isset($data)) {
            echo form_hidden('id', $data['ipk_id']);
        }
        ?>
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group">
                        ...
                        <input type="number" min="1900" max="2200" name="tahun" class="form-control" value="<?= isset($data) ? $data['ipk_tahun'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for='rata_rata'>Rata Rata IPK (ex. 3.50)</label><br>
                        <input type="text" name="rata_rata" class="form-control" value="<?= isset($data) ? $data['ipk_rata_rata'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="hidden" name="media" id="media-id" value="<?= isset($data) ? $data['ipk_media_id'] : '' ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('.form-post').submit(function(e) {
            ...
            $.ajax({
                url: base_url + '/ipk-mahasiswa/save',
                type: 'post',
                dataType: 'json',
                data: formData,
                contentType: false,
        ...
        $('.btn-media').click(function(e) {
            ...
            setLoadingBtn(btn);
            $.ajax({
                url: base_url + '/ipk-mahasiswa/media',
                data: {
                    key: 'cover'
                },
                type: 'post',
