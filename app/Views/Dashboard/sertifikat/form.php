...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List Sertifikat</button>
        </div><br><br>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for='nama'>Nama Sertifikat</label><br>
                        <input type="text" name="nama" class="form-control" value="<?= isset($data) ? $data['dokumen_nama'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for='nomor'>Nomor Sertifikat</label><br>
                        <input type="text" name="nomor" class="form-control" value="<?= isset($data) ? $data['dokumen_nomor'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for='media'>Media</label><br>
                        <div class="choose-media">
                            <a href="#" class="btn btn-sm btn-flat btn-primary btn-media" data-backdrop="static"><i class="fa fa-plus"></i> Unggah Dokumen Sertifikat Kompetensi<span id="text-optional"></span></a>
