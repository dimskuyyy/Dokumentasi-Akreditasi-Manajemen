    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                <label for='nama'>Prestasi Kegiatan</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['mahasiswa_record'] : '' ?>" id="nama" readonly>
            </div>
            <div class="form-group">
                <label for='dosen'>Nama Mahasiswa</label>
