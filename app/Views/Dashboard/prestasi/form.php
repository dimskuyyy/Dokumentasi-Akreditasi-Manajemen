...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List Prestasi Mahasiswa</button>
        </div><br><br>
        <?php echo form_open('#', ['class' => 'form-post']);
        if (isset($data)) {
            echo form_hidden('id', $data['mahasiswa_id']);
        }
        ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for='record'>Prestasi Kegiatan </label><br>
                        <input type="text" name="record" class="form-control" value="<?= isset($data) ? $data['mahasiswa_record'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for='media'>Bukti Prestasi</label><br>
                        ...
                        <input type="hidden" name="media" id="media-id" value="<?= isset($data) ? $data['mahasiswa_media_id'] : '' ?>">
