...
<?= $this->section('title') ?>
SK Pengajaran Dosen <?= AuthUser()->type_nama ?>
<?= $this->endsection() ?>

<?= $this->section('header') ?>
<section class="content-header">
    <h1>
        SK Pengajaran <?= AuthUser()->type_nama ?> <?= AuthUser()->type_nama=="Dosen" ? 'Di Luar Prodi / Kampus' : '' ?>
    </h1>
</section>
<?= $this->endsection() ?>
...
<script>
    ...
    function loadData() {
        $.ajax({
            url: base_url + '/pengajaran-dosen/datatable',
            type: 'post',
            cache: true,
    ...
    function callMedia(id, btn, htm, callback = () => {}) {
        if (id) {
            ...
            $.ajax({
                url: base_url + '/pengajaran-dosen/detail',
                type: 'post',
                data: {
                    id: id
                },
