...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List SK Pengajaran</button>
        </div><br><br>
        <?php echo form_open('#', ['class' => 'form-post']);
        if (isset($data)) {
            echo form_hidden('id', $data['pengajaran_id']);
        }
        ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" value="<?= isset($data) ? $data['pengajaran_nama'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="hidden" name="media" id="media-id" value="<?= isset($data) ? $data['pengajaran_media_id'] : '' ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('.form-post').submit(function(e) {
            ...
            $.ajax({
                url: base_url + '/pengajaran-dosen/save',
                type: 'post',
                dataType: 'json',
                data: formData,
                contentType: false,
        ...
        $('.btn-media').click(function(e) {
            ...
            setLoadingBtn(btn);
            $.ajax({
                url: base_url + '/pengajaran-dosen/media',
                data: {
                    key: 'cover'
                },
                type: 'post',
