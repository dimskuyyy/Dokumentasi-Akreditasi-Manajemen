...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> Dokumen Etika Akademik</button>
        </div><br><br>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for='media'>Unggah Dokumen Etika Akademik</label><br>
                        <div class="choose-media">
                            <a href="#" class="btn btn-sm btn-flat btn-primary btn-media" data-backdrop="static"><i class="fa fa-plus"></i> Unggah Dokumen Etika Akademik<span id="text-optional"></span></a>
...
<script>
    $(document).ready(function() {
        ...
        $('.form-post').submit(function(e) {
            ...
            $.ajax({
                url: base_url + '/etika-akademik/save',
                type: 'post',
                dataType: 'json',
                data: formData,
                contentType: false,
        ...
        $('.btn-media').click(function(e) {
            ...
            setLoadingBtn(btn);
            $.ajax({
                url: base_url + '/etika-akademik/media',
                data: {
                    key: 'cover'
                },
                type: 'post',
