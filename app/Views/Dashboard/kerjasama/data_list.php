<div class="pull-left">
    <button type="button" class="btn btn-sm btn-flat btn-primary btn-create"><i class="fa fa-plus"></i> Tambah Kerja Sama</button>
</div><br><br>
<table id="table-kerjasama" class="table table-bordered table-hover table-striped" style="width:100%">
    <thead>
        <tr>
            <th data-priority='1'>Nama</th>
            <th data-priority='1'>Mitra</th>
            <th data-priority='1'>Skala</th>
...
<script>
    $('#table-kerjasama').on('click', 'tbody tr td .btn-edit', function(e) {
        e.preventDefault();
        var btn = $(this);
        var htm = btn.html();
    ...
    $('#table-kerjasama').on('click', 'tbody tr td .btn-delete', function(e) {
        e.preventDefault();
        var btn = $(this);
        var htm = btn.html();
        var id = btn.attr('data-id');
    ...
    var oTable = $('#table-kerjasama').dataTable({
        'bFilter': false,
        'autoWidth': true,
    ...
    $('#table-kerjasama').on('click', '.btn-look', function(e) {
        e.preventDefault();
        let id = $(this).attr('data-id');
        if (id) {
            $.ajax({
                url: base_url + '/kerjasama/info',
                type: 'post',
                data: {
                    id: id
                },
