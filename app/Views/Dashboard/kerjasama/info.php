    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?= isset($data) ? $data['kerjasama_nama'] : '' ?>" id="nama" readonly>
            </div>
            <div class="form-group">
                <label for='mitra'>Mitra Kerjasama</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['kerjasama_mitra'] : '' ?>" id="mitra" readonly>
            </div>
            <div class="form-group">
                <label for='skala'>Skala Kerjasama</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['kerjasama_skala'] : '' ?>" id="skala" readonly>
            </div>
            <div class="form-group">
                <label for='tahun'>Tahun Kerjasama</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['kerjasama_tahun'] : '' ?>" id="tahun" readonly>
            </div>
            <div class="form-group">
