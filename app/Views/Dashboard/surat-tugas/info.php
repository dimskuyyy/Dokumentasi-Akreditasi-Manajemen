    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                <label for='nama'>Nama Surat Tugas</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['dokumen_nama'] : '' ?>" id="nama" readonly>
            </div>
            <div class="form-group">
                <label for='nomor'>Nomor Surat Tugas</label>
                <input type="text" class="form-control" value="<?= isset($data) ? $data['dokumen_nomor'] : '' ?>" id="nomor" readonly>
            </div>
            <div class="form-group">
