...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List Aktivitas Mahasiswa</button>
        </div><br><br>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for='record'>Nama Aktivitas </label><br>
