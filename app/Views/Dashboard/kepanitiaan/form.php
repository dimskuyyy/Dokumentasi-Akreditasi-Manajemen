...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List Kepanitiaan</button>
        </div><br><br>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn-media').click(function(e) {
            ...
            setLoadingBtn(btn);
            $.ajax({
                url: base_url + '/kepanitiaan/media',
                data: {
                    key: 'cover'
                },
                type: 'post',
