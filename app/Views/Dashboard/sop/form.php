...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> List Dokumen SOP</button>
        </div><br><br>
        <?php echo form_open('#', ['class' => 'form-post']);
        if (isset($data)) {
            echo form_hidden('id', $data['sop_id']);
        }
        ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" value="<?= isset($data) ? $data['sop_nama'] : '' ?>" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="hidden" name="media" id="media-id" value="<?= isset($data) ? $data['sop_media_id'] : '' ?>">
