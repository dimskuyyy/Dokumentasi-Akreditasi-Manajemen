...
<div class="box box-widget">
    <div class="box-body">
        <div class="pull-left">
            <button class="btn btn-sm btn-flat btn-primary btn-list"><i class="fa fa-list"></i> Dokumen Panduan Akademik</button>
        </div><br><br>
        <?php echo form_open('#', ['class' => 'form-post']);
        if (isset($data)) {
            echo form_hidden('id', $data['akademik_id']);
        }
        ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for='media'>Unggah Dokumen Panduan Akademik</label><br>
                        <div class="choose-media">
                            <a href="#" class="btn btn-sm btn-flat btn-primary btn-media" data-backdrop="static"><i class="fa fa-plus"></i> Unggah Dokumen Panduan Akademik<span id="text-optional"></span></a>
                            <button type="button" class="btn btn-default btn-flat btn-sm btn-reset-media"><i class="fa fa-recycle" aria-hidden="true"></i></button>
                        </div>
                        <input type="hidden" name="media" id="media-id" value="<?= isset($data) ? $data['akademik_media_id'] : '' ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('.form-post').submit(function(e) {
            ...
            $.ajax({
                url: base_url + '/panduan-akademik/save',
                type: 'post',
                dataType: 'json',
                data: formData,
                contentType: false,
        ...
        $('.btn-media').click(function(e) {
            ...
            setLoadingBtn(btn);
            $.ajax({
                url: base_url + '/panduan-akademik/media',
                data: {
                    key: 'cover'
                },
                type: 'post',
